  ...
  <div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border p-6 space-y-5">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <select v-model="form.category" class="input-field bg-white">
            ...
            <option value="termas">♨️ Termas</option>
      ...
      <div class="flex items-center gap-3">
        <input v-model="form.active" type="checkbox" id="active" class="w-4 h-4 accent-purple-600" />
      ...
      <button @click="save" :disabled="saving" class="w-full bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-xl font-semibold transition">
