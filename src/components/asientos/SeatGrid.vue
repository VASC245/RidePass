  ...
  <div class="space-y-4">
    ...
    <div class="grid grid-cols-5 gap-2">
      <template v-for="seat in seats" :key="seat.seat_number">
        <div
          v-if="seat.seat_number === 36"
          class="col-span-5 h-4"
        ></div>
...
const seatColor = (seat) => {
  ...
  if (selectedSeats.value.includes(seat.seat_number)) return "bg-yellow-500"; // selección solo si no es readonly
  return "bg-green-500";
};

// Seleccionar asiento (solo si no es readonly)
